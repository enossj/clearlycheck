...
define('education-tools', 'Education', ['gpa-calculator.html', 'grade-calculator.html', 'test-grade-calculator.html', 'words-to-pages-calculator.html', 'gpa-to-percentage-calculator.html', 'reading-time-calculator.html', 'word-unscrambler.html']);
